% drone_mpc_compiled - a fast solver generated by FORCESPRO v4.2.1
%
%   OUTPUT = drone_mpc_compiled(PARAMS) solves a multistage problem
...
%
%   [OUTPUT, EXITFLAG] = drone_mpc_compiled(PARAMS) returns additionally
...
%    -100 - License error
%
%   [OUTPUT, EXITFLAG, INFO] = drone_mpc_compiled(PARAMS) returns 
