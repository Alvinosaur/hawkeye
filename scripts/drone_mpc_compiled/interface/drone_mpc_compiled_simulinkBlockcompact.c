...
#define S_FUNCTION_NAME drone_mpc_compiled_simulinkBlockcompact
...
typedef drone_mpc_compiledinterface_float drone_mpc_compilednmpc_float;
...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* Input Port 0 */
    ssSetInputPortMatrixDimensions(S,  0, 55, 1);
	...
	/* Input Port 2 */
    ssSetInputPortMatrixDimensions(S,  2, 30, 1);
	...
	/* Output Port 0 */
    ssSetOutputPortMatrixDimensions(S,  0, 55, 1);
