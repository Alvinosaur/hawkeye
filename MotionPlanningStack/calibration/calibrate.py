...
def calibrate(dirpath, prefix, image_format, square_size, width=9, height=6):
    ...
    for fname in images:
        ...
        if ret:
            ...
            print("saving to: %s" % "processed_" + fname)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_dir', type=str, required=False, help='image directory path', default="images")
    parser.add_argument('--image_format', type=str, required=False, help='image format, png/jpg', default="jpg")
    parser.add_argument('--prefix', type=str, required=False, help='image prefix', default="img")
    parser.add_argument('--square_size', type=float, required=False, help='chessboard square size', default=0.016)
